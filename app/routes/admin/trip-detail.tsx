          ...
          {imageUrls.map((url: string, i: number) => (
            <img
              ...
              className={cn(
                ...
                i === 0 ? "md:col-span-2 md:row-span-2 h-82.5" : "md:row-span-1 h-37.5",
              )}
            />
          ))}
        </section>
            ...
            <li key={index}>
              ...
              <ul>
                {dayPlan.activities.map((activity, index: number) => (
                  <li key={index}>
                    <span className="shrink-0 text-[14px] md:text-[18px] font-semibold">{activity.time}</span>
                    <p className="grow text-[14px] md:text-[18px]">{activity.description}</p>
                  </li>
                ))}
              </ul>
            </li>
